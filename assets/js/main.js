 ...
 * ========================================================================
 ...
 10.4 Product Collection Five Prodotti Slider
...
(function ($) {
    ...
    if ($('#Prodotti-detail-tabs').length) {
        var footTop = $('#Prodotti-detail-tabs').offset().top - parseFloat($('#Prodotti-detail-tabs').css('marginTop').replace(/auto/, 0));
    }
    ...
    $(window).scroll(function (evt) {
        ...
        if (y > top) {
            ...
            if (y < maxY) {
                ...
                //Quand la pro-details-sticky arrive au Prodotti-detail-tabs, supprime la classe "fixed" pr̩c̬dement ajout̩
